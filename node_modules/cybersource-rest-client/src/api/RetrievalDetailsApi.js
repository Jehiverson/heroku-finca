...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReportingV3RetrievalDetailsGet200Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ReportingV3RetrievalDetailsGet200Response'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.RetrievalDetailsApi = factory(root.CyberSource.ApiClient, root.CyberSource.ReportingV3RetrievalDetailsGet200Response);
  }
}(this, function(ApiClient, ReportingV3RetrievalDetailsGet200Response) {
  'use strict';

  /**
   * RetrievalDetails service.
   * @module api/RetrievalDetailsApi
   * @version 0.0.1
   */

  /**
   * Constructs a new RetrievalDetailsApi. 
   * @alias module:api/RetrievalDetailsApi
   * @class
  ...
  var exports = function(configObject, apiClient) {
    ...
    /**
     * Callback function to receive the result of the getRetrievalDetails operation.
     * @callback module:api/RetrievalDetailsApi~getRetrievalDetailsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportingV3RetrievalDetailsGet200Response} data The data returned by the service call.
    ...
    this.getRetrievalDetails = function(startTime, endTime, opts, callback) {
      ...
      if (startTime === undefined || startTime === null) {
        throw new Error("Missing the required parameter 'startTime' when calling getRetrievalDetails");
      }

      // verify the required parameter 'endTime' is set
      if (endTime === undefined || endTime === null) {
        throw new Error("Missing the required parameter 'endTime' when calling getRetrievalDetails");
      }
      ...
      var returnType = ReportingV3RetrievalDetailsGet200Response;

      return this.apiClient.callApi(
        '/reporting/v3/retrieval-details', 'GET',

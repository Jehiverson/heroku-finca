...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse4005', 'model/InlineResponse5001', 'model/UpdatePGPKeysRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse4005'), require('../model/InlineResponse5001'), require('../model/UpdatePGPKeysRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.KeyManagementPgpApi = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse4005, root.CyberSource.InlineResponse5001, root.CyberSource.UpdatePGPKeysRequest);
  }
}(this, function(ApiClient, InlineResponse4005, InlineResponse5001, UpdatePGPKeysRequest) {
  'use strict';

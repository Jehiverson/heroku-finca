...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.KmsV2KeysAsymPost201ResponseKeyInformation = factory(root.CyberSource.ApiClient, root.CyberSource.KmsV2KeysSymPost201ResponseErrorInformation);
  }
  ...
  /**
   * The KmsV2KeysAsymPost201ResponseKeyInformation model module.
   * @module model/KmsV2KeysAsymPost201ResponseKeyInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>KmsV2KeysAsymPost201ResponseKeyInformation</code>.
   * key information 
   * @alias module:model/KmsV2KeysAsymPost201ResponseKeyInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>KmsV2KeysAsymPost201ResponseKeyInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KmsV2KeysAsymPost201ResponseKeyInformation} obj Optional instance to populate.
   * @return {module:model/KmsV2KeysAsymPost201ResponseKeyInformation} The populated <code>KmsV2KeysAsymPost201ResponseKeyInformation</code> instance.
   */

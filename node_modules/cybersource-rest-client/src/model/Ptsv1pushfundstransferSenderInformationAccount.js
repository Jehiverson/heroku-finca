...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv1pushfundstransferSenderInformationAccount = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv1pushfundstransferSenderInformationAccount model module.
   * @module model/Ptsv1pushfundstransferSenderInformationAccount
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv1pushfundstransferSenderInformationAccount</code>.
   * @alias module:model/Ptsv1pushfundstransferSenderInformationAccount
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv1pushfundstransferSenderInformationAccount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv1pushfundstransferSenderInformationAccount} obj Optional instance to populate.
   * @return {module:model/Ptsv1pushfundstransferSenderInformationAccount} The populated <code>Ptsv1pushfundstransferSenderInformationAccount</code> instance.
   */

...
(function(root, factory) {
  ...
  /**
   * The PostCustomerRequest model module.
   * @module model/PostCustomerRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PostCustomerRequest</code>.
   * @alias module:model/PostCustomerRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PostCustomerRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostCustomerRequest} obj Optional instance to populate.

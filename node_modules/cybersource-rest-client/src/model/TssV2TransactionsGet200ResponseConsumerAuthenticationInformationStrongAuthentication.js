...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication model module.
   * @module model/TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication</code>.
   * @alias module:model/TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication
   * @class
   */
  ...
  /**
   * Constructs a <code>TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication} obj Optional instance to populate.
   * @return {module:model/TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication} The populated <code>TssV2TransactionsGet200ResponseConsumerAuthenticationInformationStrongAuthentication</code> instance.
   */

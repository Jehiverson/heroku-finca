...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20012EmbeddedLinks', 'model/InlineResponse20012EmbeddedTotals'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20012EmbeddedLinks'), require('./InlineResponse20012EmbeddedTotals'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse20012EmbeddedBatches = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse20012EmbeddedLinks, root.CyberSource.InlineResponse20012EmbeddedTotals);
  }
}(this, function(ApiClient, InlineResponse20012EmbeddedLinks, InlineResponse20012EmbeddedTotals) {
  'use strict';
  ...
  /**
   * The InlineResponse20012EmbeddedBatches model module.
   * @module model/InlineResponse20012EmbeddedBatches
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20012EmbeddedBatches</code>.
   * @alias module:model/InlineResponse20012EmbeddedBatches
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20012EmbeddedBatches</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20012EmbeddedBatches} obj Optional instance to populate.
   * @return {module:model/InlineResponse20012EmbeddedBatches} The populated <code>InlineResponse20012EmbeddedBatches</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_links')) {
        obj['_links'] = InlineResponse20012EmbeddedLinks.constructFromObject(data['_links']);
      }
  ...
  /**
   * @member {module:model/InlineResponse20012EmbeddedLinks} _links
   */

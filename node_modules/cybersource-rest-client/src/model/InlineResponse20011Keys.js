...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20011Keys = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20011Keys model module.
   * @module model/InlineResponse20011Keys
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20011Keys</code>.
   * KeyResponseEntry
   * @alias module:model/InlineResponse20011Keys
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20011Keys</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20011Keys} obj Optional instance to populate.
   * @return {module:model/InlineResponse20011Keys} The populated <code>InlineResponse20011Keys</code> instance.
   */

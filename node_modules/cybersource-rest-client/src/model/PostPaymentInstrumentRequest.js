...
(function(root, factory) {
  ...
  /**
   * The PostPaymentInstrumentRequest model module.
   * @module model/PostPaymentInstrumentRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PostPaymentInstrumentRequest</code>.
   * @alias module:model/PostPaymentInstrumentRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PostPaymentInstrumentRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostPaymentInstrumentRequest} obj Optional instance to populate.
   * @return {module:model/PostPaymentInstrumentRequest} The populated <code>PostPaymentInstrumentRequest</code> instance.
   */

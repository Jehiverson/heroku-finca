...
(function(root, factory) {
  ...
  /**
   * The PaymentInstrumentListEmbedded model module.
   * @module model/PaymentInstrumentListEmbedded
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentInstrumentListEmbedded</code>.
   * Payment Instrument Resources. 
   * @alias module:model/PaymentInstrumentListEmbedded
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentInstrumentListEmbedded</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentInstrumentListEmbedded} obj Optional instance to populate.
   * @return {module:model/PaymentInstrumentListEmbedded} The populated <code>PaymentInstrumentListEmbedded</code> instance.
   */

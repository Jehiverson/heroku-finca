...
(function(root, factory) {
  ...
  /**
   * The PatchCustomerRequest model module.
   * @module model/PatchCustomerRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PatchCustomerRequest</code>.
   * @alias module:model/PatchCustomerRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PatchCustomerRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PatchCustomerRequest} obj Optional instance to populate.

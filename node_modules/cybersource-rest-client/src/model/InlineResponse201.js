...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse201PlanInformation', 'model/PtsV2IncrementalAuthorizationPatch201ResponseLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse201PlanInformation'), require('./PtsV2IncrementalAuthorizationPatch201ResponseLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse201 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse201PlanInformation, root.CyberSource.PtsV2IncrementalAuthorizationPatch201ResponseLinks);
  }
}(this, function(ApiClient, InlineResponse201PlanInformation, PtsV2IncrementalAuthorizationPatch201ResponseLinks) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('planInformation')) {
        obj['planInformation'] = InlineResponse201PlanInformation.constructFromObject(data['planInformation']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse201PlanInformation} planInformation
   */

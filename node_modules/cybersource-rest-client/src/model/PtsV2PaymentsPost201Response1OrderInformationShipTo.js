...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PtsV2PaymentsPost201Response1OrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PtsV2PaymentsPost201Response1OrderInformationShipTo model module.
   * @module model/PtsV2PaymentsPost201Response1OrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsPost201Response1OrderInformationShipTo</code>.
   * @alias module:model/PtsV2PaymentsPost201Response1OrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsPost201Response1OrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsPost201Response1OrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/PtsV2PaymentsPost201Response1OrderInformationShipTo} The populated <code>PtsV2PaymentsPost201Response1OrderInformationShipTo</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.RiskV1AuthenticationsPost400Response1 = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseErrorInformationDetails);
  }
  ...
  /**
   * The RiskV1AuthenticationsPost400Response1 model module.
   * @module model/RiskV1AuthenticationsPost400Response1
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>RiskV1AuthenticationsPost400Response1</code>.
   * @alias module:model/RiskV1AuthenticationsPost400Response1
   * @class
   */
  ...
  /**
   * Constructs a <code>RiskV1AuthenticationsPost400Response1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskV1AuthenticationsPost400Response1} obj Optional instance to populate.
   * @return {module:model/RiskV1AuthenticationsPost400Response1} The populated <code>RiskV1AuthenticationsPost400Response1</code> instance.
   */

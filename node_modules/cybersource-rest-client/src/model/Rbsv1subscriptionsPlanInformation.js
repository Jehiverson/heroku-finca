...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Rbsv1subscriptionsPlanInformation = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse200PlanInformationBillingPeriod, root.CyberSource.Rbsv1plansPlanInformationBillingCycles);
  }
  ...
  /**
   * The Rbsv1subscriptionsPlanInformation model module.
   * @module model/Rbsv1subscriptionsPlanInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Rbsv1subscriptionsPlanInformation</code>.
   * @alias module:model/Rbsv1subscriptionsPlanInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Rbsv1subscriptionsPlanInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Rbsv1subscriptionsPlanInformation} obj Optional instance to populate.
   * @return {module:model/Rbsv1subscriptionsPlanInformation} The populated <code>Rbsv1subscriptionsPlanInformation</code> instance.
   */

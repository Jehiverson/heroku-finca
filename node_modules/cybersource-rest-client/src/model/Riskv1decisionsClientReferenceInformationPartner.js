...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1decisionsClientReferenceInformationPartner = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1decisionsClientReferenceInformationPartner model module.
   * @module model/Riskv1decisionsClientReferenceInformationPartner
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1decisionsClientReferenceInformationPartner</code>.
   * @alias module:model/Riskv1decisionsClientReferenceInformationPartner
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1decisionsClientReferenceInformationPartner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1decisionsClientReferenceInformationPartner} obj Optional instance to populate.
   * @return {module:model/Riskv1decisionsClientReferenceInformationPartner} The populated <code>Riskv1decisionsClientReferenceInformationPartner</code> instance.
   */

...
(function(root, factory) {
  ...
  /**
   * The PatchCustomerShippingAddressRequest model module.
   * @module model/PatchCustomerShippingAddressRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PatchCustomerShippingAddressRequest</code>.
   * @alias module:model/PatchCustomerShippingAddressRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PatchCustomerShippingAddressRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PatchCustomerShippingAddressRequest} obj Optional instance to populate.
   * @return {module:model/PatchCustomerShippingAddressRequest} The populated <code>PatchCustomerShippingAddressRequest</code> instance.
   */

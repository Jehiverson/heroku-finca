...
(function(root, factory) {
  ...
  /**
   * The UpdatePlanRequest model module.
   * @module model/UpdatePlanRequest
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>UpdatePlanRequest</code>.
   * @alias module:model/UpdatePlanRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdatePlanRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdatePlanRequest} obj Optional instance to populate.
   * @return {module:model/UpdatePlanRequest} The populated <code>UpdatePlanRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('planInformation')) {
        obj['planInformation'] = Rbsv1plansidPlanInformation.constructFromObject(data['planInformation']);
      }
  ...
  /**
   * @member {module:model/Rbsv1plansidPlanInformation} planInformation
   */
  exports.prototype['planInformation'] = undefined;
  /**
   * @member {module:model/Rbsv1plansidProcessingInformation} processingInformation
   */

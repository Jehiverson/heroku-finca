...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications model module.
   * @module model/TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications</code>.
   * @alias module:model/TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications
   * @class
   */
  ...
  /**
   * Constructs a <code>TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications} obj Optional instance to populate.
   * @return {module:model/TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications} The populated <code>TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications</code> instance.
   */

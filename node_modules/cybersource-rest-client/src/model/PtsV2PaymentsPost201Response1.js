...
(function(root, factory) {
  ...
  /**
   * The PtsV2PaymentsPost201Response1 model module.
   * @module model/PtsV2PaymentsPost201Response1
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsPost201Response1</code>.
   * @alias module:model/PtsV2PaymentsPost201Response1
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsPost201Response1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsPost201Response1} obj Optional instance to populate.
   * @return {module:model/PtsV2PaymentsPost201Response1} The populated <code>PtsV2PaymentsPost201Response1</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('paymentInformation')) {
        obj['paymentInformation'] = PtsV2PaymentsPost201Response1PaymentInformation.constructFromObject(data['paymentInformation']);
      }
      if (data.hasOwnProperty('orderInformation')) {
        obj['orderInformation'] = PtsV2PaymentsPost201Response1OrderInformation.constructFromObject(data['orderInformation']);
      }
  ...
  /**
   * @member {module:model/PtsV2PaymentsPost201Response1PaymentInformation} paymentInformation
   */
  exports.prototype['paymentInformation'] = undefined;
  /**
   * @member {module:model/PtsV2PaymentsPost201Response1OrderInformation} orderInformation
   */

...
(function(root, factory) {
  ...
  /**
   * The Rbsv1plansPlanInformation model module.
   * @module model/Rbsv1plansPlanInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Rbsv1plansPlanInformation</code>.
  ...
  /**
   * Constructs a <code>Rbsv1plansPlanInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Rbsv1plansPlanInformation} obj Optional instance to populate.
   * @return {module:model/Rbsv1plansPlanInformation} The populated <code>Rbsv1plansPlanInformation</code> instance.
   */

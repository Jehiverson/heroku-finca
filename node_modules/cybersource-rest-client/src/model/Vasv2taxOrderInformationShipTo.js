...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Vasv2taxOrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Vasv2taxOrderInformationShipTo model module.
   * @module model/Vasv2taxOrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Vasv2taxOrderInformationShipTo</code>.
   * @alias module:model/Vasv2taxOrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Vasv2taxOrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Vasv2taxOrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/Vasv2taxOrderInformationShipTo} The populated <code>Vasv2taxOrderInformationShipTo</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2011Links', 'model/InlineResponse2011SubscriptionInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2011Links'), require('./InlineResponse2011SubscriptionInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2011 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2011Links, root.CyberSource.InlineResponse2011SubscriptionInformation);
  }
}(this, function(ApiClient, InlineResponse2011Links, InlineResponse2011SubscriptionInformation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('subscriptionInformation')) {
        obj['subscriptionInformation'] = InlineResponse2011SubscriptionInformation.constructFromObject(data['subscriptionInformation']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2011SubscriptionInformation} subscriptionInformation
   */

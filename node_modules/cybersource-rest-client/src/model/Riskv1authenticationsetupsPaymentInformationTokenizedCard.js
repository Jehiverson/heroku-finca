...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationsetupsPaymentInformationTokenizedCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationsetupsPaymentInformationTokenizedCard model module.
   ...
   */
  var exports = function(transactionType, type, expirationMonth, expirationYear, _number) {
    var _this = this;
  ...
  /**
   * Constructs a <code>Riskv1authenticationsetupsPaymentInformationTokenizedCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationsetupsPaymentInformationTokenizedCard} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationsetupsPaymentInformationTokenizedCard} The populated <code>Riskv1authenticationsetupsPaymentInformationTokenizedCard</code> instance.
   */

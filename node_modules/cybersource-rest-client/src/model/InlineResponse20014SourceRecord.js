...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20014SourceRecord = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20014SourceRecord model module.
   * @module model/InlineResponse20014SourceRecord
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20014SourceRecord</code>.
   * @alias module:model/InlineResponse20014SourceRecord
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20014SourceRecord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20014SourceRecord} obj Optional instance to populate.
   * @return {module:model/InlineResponse20014SourceRecord} The populated <code>InlineResponse20014SourceRecord</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2paymentsidrefundsClientReferenceInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsClientReferenceInformationPartner);
  }
  ...
  /**
   * The Ptsv2paymentsidrefundsClientReferenceInformation model module.
   * @module model/Ptsv2paymentsidrefundsClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidrefundsClientReferenceInformation</code>.
   * @alias module:model/Ptsv2paymentsidrefundsClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidrefundsClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidrefundsClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidrefundsClientReferenceInformation} The populated <code>Ptsv2paymentsidrefundsClientReferenceInformation</code> instance.
   */

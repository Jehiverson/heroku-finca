...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20012EmbeddedTotals', 'model/InlineResponse20013Billing', 'model/InlineResponse20014Records'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20012EmbeddedTotals'), require('./InlineResponse20013Billing'), require('./InlineResponse20014Records'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse20014 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse20012EmbeddedTotals, root.CyberSource.InlineResponse20013Billing, root.CyberSource.InlineResponse20014Records);
  }
}(this, function(ApiClient, InlineResponse20012EmbeddedTotals, InlineResponse20013Billing, InlineResponse20014Records) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('records')) {
        obj['records'] = ApiClient.convertToType(data['records'], [InlineResponse20014Records]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/InlineResponse20014Records>} records
   */
